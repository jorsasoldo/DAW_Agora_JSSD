...
function App() {
  ...
  return (<BrowserRouter><Routes>{}<Route path="/login" element={<RutaPublica><Login /></RutaPublica>} /><Route path="/registro" element={<RutaPublica><Registro /></RutaPublica>} /><Route path="/perfil-setup" element={<RutaPublica><PerfilSetup /></RutaPublica>} />{}<Route path="/" element={<RutaProtegida><LayoutPrincipal><Inicio /></LayoutPrincipal></RutaProtegida>} />{}<Route path="/comunidades" element={<RutaProtegida><LayoutPrincipal><Comunidades /></LayoutPrincipal></RutaProtegida>} /><Route path="/c/:id" element={<RutaProtegida><LayoutPrincipal><PaginaComunidad /></LayoutPrincipal></RutaProtegida>} /><Route path="*" element={<Navigate to="/" replace />} /></Routes></BrowserRouter>)
}
